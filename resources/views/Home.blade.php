...
<div class="triangle-left">
            ...
            <div class="container" style="margin-bottom: 30px;">
                <div class="row">
                    <div class="col">
                            ...
                            ThinkBig komanda padės Jūsų idėjai atsispirti nuo starto linijos. Esame jaunos, pažangios asmenybės, siekiančios užsibrėžtų tikslų. Mūsų komanda kuria Android bei iOS mobiliąsias aplikacijas (mobile app) verslo ir individualiems klientams.
                            </h1> 

                            <h1 style="font-size:18px; text-align: left;">
                            Mobiliasias aplikacijas kuriame su pačiomis profesionaliausiomis Native technologijomis – Java, Kotlin, Swift, Objective-C programavimo kalbomis. Užsiimame Android, iOS, Front-end, Back-end programavimu, serverinės dalies parengimu, žiniatinklio paslaugų kūrimu komunikacijai tarp serverio ir mobiliosios aplikacijos, WEB administravimo aplikacijų kūrimu, projektų vystymu bei plėtra.
                            </h1>

                            <h1 style="font-size:18px; text-align: left;">
                            Mes nekantraujame sukurti mobiliąją programėlę Jūsų projektui, internetiniam puslapiui, verslui ar pomėgiui!
                            </h1>     
    ...
    <div class="demo11">
            <div class="container">
                <h4 style="text-align:center;  font-weight: 900;">PRICES</h4>
                <div class="row">
